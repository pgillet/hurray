...
- **Extensible and evolvable:** extension points are stable across 1.x; new named values go through the spec amendment process; backward and forward-additive compatibility is guaranteed within major version `1.x`. See [`versioning.md`](versioning.md) § Evolvability Contract.
